...
sudo apt update -q
sudo apt-get install -q --yes docker-ce=5:20.10.18~3-0~ubuntu-focal --allow-downgrades
...
kubectl apply -f https://raw.githubusercontent.com/bweissman/public-helpers/master/k8s_Azure_VM/rbac_122.yaml
